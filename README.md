...
I'd recommend using one of the first two methods of testing my mod because they are by far the easiest to use, and you can't use the 3rd option with any other mods.    
Any other pages where you might find my mod are not made by me!
...
It also adds a couple of new block entities like a grinder that can turn wheat into flour and a cooking pot (that doesn't do anything meaningful yet)
Additionally it adds a couple of other things, like yeast that ferments when placed or bread dough that can be baked into bread in a furnace.
