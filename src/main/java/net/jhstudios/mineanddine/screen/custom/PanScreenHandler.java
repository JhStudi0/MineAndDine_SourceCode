...
public class PanScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    private static final int MACHINE_SLOT_COUNT = 8;
    private static final int OUTPUT_SLOT = 6;

    public PanScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(pos), new ArrayPropertyDelegate(2));
    }


    public PanScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate propertyDelegate) {
        super(ModScreenHandlers.PAN_SCREEN_HANDLER, syncId);
        ...
        this.addSlot(new Slot(inventory, 7, 94, 56));

        this.addSlot(new Slot(inventory, 6, 132, 29){
            @Override
